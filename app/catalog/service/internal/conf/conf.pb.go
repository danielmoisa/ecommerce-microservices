...
const file_internal_conf_conf_proto_rawDesc = "" +
	...
	"\tBootstrap\x12'\n" +
	"\x05trace\x18\x01 \x01(\v2\x11.kratos.api.TraceR\x05trace\x12*\n" +
	"\x06server\x18\x02 \x01(\v2\x12.kratos.api.ServerR\x06server\x12$\n" +
	"\x04data\x18\x03 \x01(\v2\x10.kratos.api.DataR\x04data\"#\n" +
	"\x05Trace\x12\x1a\n" +
	...
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x123\n" +
	"\atimeout\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\atimeout\"\xaf\x02\n" +
	"\x04Data\x125\n" +
	...
	"\x06scheme\x18\x02 \x01(\tR\x06schemeB(Z&app/catalog/service/internal/conf;confb\x06proto3"
