...
func (pc *ProductCreate) SetImages(b []biz.Image) *ProductCreate {
	pc.mutation.SetImages(b)
	return pc
}
...
func (pc *ProductCreate) check() error {
	...
	if _, ok := pc.mutation.Count(); !ok {
		return &ValidationError{Name: "count", err: errors.New(`ent: missing required field "Product.count"`)}
	}
