...
const OperationShopInterfaceGetProduct = "/shop.interface.v1.ShopInterface/GetProduct"
...
const OperationShopInterfaceListProduct = "/shop.interface.v1.ShopInterface/ListProduct"
...
func RegisterShopInterfaceHTTPServer(s *http.Server, srv ShopInterfaceHTTPServer) {
	...
	r.GET("/v1/catalog/products", _ShopInterface_ListProduct0_HTTP_Handler(srv))
	r.GET("/v1/catalog/products/{id}", _ShopInterface_GetProduct0_HTTP_Handler(srv))
...
func _ShopInterface_ListProduct0_HTTP_Handler(srv ShopInterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in ListProductReq
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationShopInterfaceListProduct)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _ShopInterface_GetProduct0_HTTP_Handler(srv ShopInterfaceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, OperationShopInterfaceGetProduct)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
type ShopInterfaceHTTPClient interface {
	...
	GetProduct(ctx context.Context, req *GetProductReq, opts ...http.CallOption) (rsp *GetProductReply, err error)
...
func (c *ShopInterfaceHTTPClientImpl) GetProduct(ctx context.Context, in *GetProductReq, opts ...http.CallOption) (*GetProductReply, error) {
	var out GetProductReply
	pattern := "/v1/catalog/products/{id}"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationShopInterfaceGetProduct))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *ShopInterfaceHTTPClientImpl) ListProduct(ctx context.Context, in *ListProductReq, opts ...http.CallOption) (*ListProductReply, error) {
	var out ListProductReply
	pattern := "/v1/catalog/products"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationShopInterfaceListProduct))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
